...
<div class="lsyr_app-body ">
    <div class="lsyr_review-box lsyr_review-unselectable">
        <div class="lsyr_business-summary-rating-badge-view__rating">
          <?php echo $arResult['COMPANY_FOR_COMPONENT']->getName(); ?>
          <br>
          <br>
          <?php echo $arResult['COMPANY_FOR_COMPONENT']->getRating(); ?>
          <?php echo Loc::getMessage('LEADSPACE_YANDEXREVIEWSSLIDER_IZ'); ?>
        </div>
